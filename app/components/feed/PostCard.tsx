    ...
    <article className="overflow-hidden rounded-3xl bg-white shadow-soft-xs">
      ...
      <div className="px-6 pt-6">
        ...
        {isEditing ? (
          ...
          <>
            <p className="mt-5 text-sm leading-6 text-neutral-darker">
              {post.content}
            </p>
      ...
      <div className="border-t border-neutral-light px-6 py-4">
        ...
        <div className="flex gap-4 border-t border-neutral-light pt-3">
          <button
            onClick={handleLike}
        ...
        {comments.length > 0 && (
          <div className="mt-4 space-y-3 border-t border-neutral-light pt-4">
        ...
        {showCommentForm && (
          <div className="mt-4 flex gap-2 border-t border-neutral-light pt-4">
            <input
              type="text"
              value={newComment}
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-neutral-darker/35 px-4 py-8 backdrop-blur-[4px]">
      <section
        ...
        className="w-full max-w-[380px] rounded-2xl bg-white px-7 pb-7 pt-8 text-center shadow-soft-lg"
      >
        <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-danger-light text-danger-primary">
...
function DeleteSuccessDialog({ onClose }: { onClose: () => void }) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-neutral-darker/25 px-4 py-8 backdrop-blur-[4px]">
      <section
        role="dialog"
        aria-modal="true"
        aria-labelledby="delete-success-title"
        className="w-full max-w-[360px] rounded-2xl bg-white px-7 pb-7 pt-8 text-center shadow-soft-lg"
      >
        <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-success-light text-primary-dark">
