    ...
    <main className="min-h-screen bg-[#f8f8f3] text-[#222a20]">
      ...
      <div className="mx-auto max-w-[1132px] px-4 pb-20 pt-10 sm:px-6 lg:px-1">
        <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h1 className="text-[30px] font-black tracking-[-0.03em] text-[#1e261e]">
          ...
          <Link
            href="/feed"
            className="inline-flex h-11 items-center justify-center rounded-full border border-[#d9e0d4] bg-white px-6 text-[12px] font-black text-[#287630] transition hover:bg-[#f4f6f1]"
          >
            Voltar ao feed
          </Link>
        </div>
        ...
        <div className="grid gap-6 sm:grid-cols-2 xl:grid-cols-3">
          {suggestions.map((profile) => (
            <article
              key={profile.slug}
              className="overflow-hidden rounded-[28px] bg-white shadow-[0_1px_0_rgba(33,55,30,0.04)]"
            >
              <div
              ...
              <div className="p-6">
                <div className="mb-4 flex items-center gap-3">
                  <div className={`h-12 w-12 rounded-full ${profile.color} ring-2 ring-[#e8efdf]`}>
                    <span className="flex h-full items-center justify-center text-[18px] font-black text-white">
                      {readInitials(profile.name)}
                    </span>
                  </div>
                  <div className="min-w-0">
                    <h2 className="truncate text-[15px] font-black text-[#1e261e]">
                      {profile.name}
                    </h2>
                ...
                <div className="flex flex-wrap gap-3">
                  <Link
                    ...
                    className="rounded-full bg-[#287630] px-4 py-2 text-[12px] font-black text-white transition hover:bg-[#1f6f2a]"
                  >
                    Ver perfil
                  </Link>
                  <button
                    type="button"
                    className="rounded-full border border-[#d9e0d4] bg-white px-4 py-2 text-[12px] font-black text-[#287630] transition hover:bg-[#f4f6f1]"
                  >
                    Conectar
                  </button>
                </div>

                <div className="mt-6 flex items-center gap-3 text-[12px] text-[#8a9186]">
