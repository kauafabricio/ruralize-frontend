...
function EditCreatedEventDialog({
  ...
  const [form, setForm] = useState<UserEventInput>(eventToInput(event));
              ...
              >
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <RegistrationField
                    ...
                    value={formatRegistrationDate(registration)}
                  />
                </div>
                <RegistrationField
                  label="Motivacao"
...
function formatRegistrationDate(registration: EventParticipant) {
  const dateValue = registration.registered_at ?? registration.created_at;
